...
import { Activity, BarChart3, Bot, CalendarClock, CandlestickChart, Check, ChevronDown, FileText, Fingerprint, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2 } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/shadow", icon: Fingerprint, label: t('layout.shadowAccount', { defaultValue: 'Shadow Account' }) },
